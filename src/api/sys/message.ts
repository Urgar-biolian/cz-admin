...
export function getMsgApi(mode: ErrorMessageMode = "modal") {
...
export function createMsgApi(info: MessageParams) {
...
export function updateMsgApi(id: number, info: MessageParams) {
  return defHttp.post<MessageResultModel>(
    {
...
export function removeMsgApi(id: number) {
