...
export function getProjApi(mode: ErrorMessageMode = "modal") {
...
export function createProjApi(info: ProjectParams) {
...
export function updateProjApi(id: number, info: ProjectParams) {
  return defHttp.post<ProjectResultModel>(
    {
...
export function removeProjApi(id: number) {
